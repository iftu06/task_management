...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskDto save(Task task) {
        ...
        return TaskDto.convertToDto(persistenceTask,baseUrl);
    }
    ...
    public TaskDto getTask(Integer taskId) {
        ...
        if (UserUtil.isAdmin()) {
            return TaskDto.convertToDto(task.get(),baseUrl);
        } else {
    ...
    public List<TaskDto> getAllTasks() {
        ...
        return !tasks.isEmpty() ? TaskDto.convertToDto(tasks,baseUrl) : new ArrayList<TaskDto>();
    ...
    public List<TaskDto> searchTask(TaskSeachField seachField) {
        ...
        return TaskDto.convertToDto(tasks,baseUrl);
